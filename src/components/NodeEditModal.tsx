...
export default function NodeEditModal({ isOpen, onClose, onSave, nodeData }: NodeEditModalProps) {
  ...
  const handleCreateChildMap = async (newMapTitle: string) => {
    ...
    setIsCreateChildMapModalOpen(false); // Close modal after creation
  };
  ...
  return (
    <>
          ...
          <div className="p-6 sm:p-8">
            ...
            <div className="space-y-4">
              ...
              {nodeData.child_map_id ? (
                  ...
                  <button onClick={() => setIsCreateChildMapModalOpen(true)} className="inline-flex items-center space-x-2 text-sm font-medium text-slate-600 hover:text-slate-900">
                      <Plus className="w-4 h-4" />
      ...
      <CreateMapModal
        isOpen={isCreateChildMapModalOpen}
        onClose={() => setIsCreateChildMapModalOpen(false)}
        onCreateMap={handleCreateChildMap}
      />
    </>
  );
}
